    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        >
          ...
          <div className="relative z-10 min-h-64 sm:min-h-96 lg:min-h-112 max-h-96 sm:max-h-full px-4 py-8 sm:px-8 lg:px-10 lg:py-10">
            <div className="flex h-full flex-col justify-end pt-16 sm:pt-32 lg:pt-44">
